...
class NearEarthObject:
    ...
    def __str__(self):
        ...
        if not self.hazardous:
            return f"NEO {self.fullname} has a diameter of  {self.diameter} Kms and is not potentially hazardous." 
...
class CloseApproach:
    ...
    def __init__(self, **info):
        ...
        self._designation = str(info.get("des", "Iknown asteroid"))
        ...
        self.neo = info.get("neo", "Iknown CO")
